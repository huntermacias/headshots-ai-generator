...
export default async function Index() {
  ...
  return (
    <div className="flex flex-col items-center bg-[#121212] text-[#E0E0E0] min-h-screen">
      <div className="p-6 max-w-7xl w-full">
        ...
        <section className="flex flex-col items-center gap-8 text-center">
          ...
          <div className="space-y-4 sm:space-y-0 sm:flex sm:gap-6 sm:justify-center">
            <Link href="/login"
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l text-white font-semibold py-2 px-4 md:px-8 rounded-lg shadow-lg transition-transform hover:-translate-y-1 hover:scale-105">
              Get Your Headshots
            </Link>
        ...
        <section className="px-4 py-8 lg:py-16 relative overflow-hidden w-full rounded-md">
        <div className="absolute inset-0 bg-black opacity-80 filter blur-lg"></div>
        <h2 className="text-3xl lg:text-5xl font-bold text-center text-white mb-8 lg:mb-16 z-10 relative">
          Popular Headshot Collections
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-4 z-10 relative">

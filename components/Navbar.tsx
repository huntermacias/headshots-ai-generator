...
export default async function Navbar() {
  ...
  return (
    <nav className="flex w-full px-3 md:px-8 lg:px-24 py-3 items-center border-b border-gray-500 bg-gradient-to-r from-transparent via-purple-600/30 to-transparent text-white justify-between relative z-20">
    <Link href="/" passHref
      className="text-lg md:text-xl font-semibold tracking-wide hover:text-opacity-80 transition duration-200 ease-in-out">
      Headshots AI
    </Link>
